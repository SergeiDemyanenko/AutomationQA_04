...
public abstract class BaseTablePage extends MainPage {
    ...
    private final By TD_LANGUAGE_NAMES = By.xpath("//table[@id='category']/tbody/tr/td[1]");

    protected BaseTablePage(WebDriver driver) {
    ...
    public String getLanguage(String nameLanguage) {
    ...
    public String getTitlesTable() {
        ...
        List<WebElement> titles = getThTags();
